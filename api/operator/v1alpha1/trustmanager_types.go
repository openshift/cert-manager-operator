...
type TrustManagerConfig struct {
	...
	// When omitted, defaults to "cert-manager".
	...
	// When omitted, trust-manager cannot write trust bundles to Secrets.
	// +kubebuilder:validation:Optional
	// +optional
	...
	// When set to "Disabled", expired certificates are included in bundles.
	...
	// When omitted, defaults to the default CA package being disabled.
	// +kubebuilder:validation:Optional
	// +optional
...
type SecretTargetsConfig struct {
	...
	// "Disabled" means trust-manager cannot write trust bundles to Secrets.
...
type DefaultCAPackageConfig struct {
	...
	// When set to "Disabled", no default CA package is configured and Bundles cannot use useDefaultCAs.
	// When omitted, defaults to "Disabled".
	// +kubebuilder:default:="Disabled"
	// +kubebuilder:validation:Optional
	// +optional

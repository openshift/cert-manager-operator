...
type TrustManagerConfig struct {
	...
	// to provide a default CA package that can be consumed by Bundle resources using
	// the "useDefaultCAs: true" source.
	// +kubebuilder:validation:Optional
	// +optional
...
type DefaultCAPackageConfig struct {
	...
	// When set to "Disabled", no default CA package is configured and Bundles cannot
	// use useDefaultCAs (default behavior).
	// +kubebuilder:default:="Disabled"
	// +kubebuilder:validation:Optional
	// +optional

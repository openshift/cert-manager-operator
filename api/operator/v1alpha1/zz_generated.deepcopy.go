...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in TechPreview) DeepCopyInto(out *TechPreview) {
	{
		in := &in
		*out = make(TechPreview, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TechPreview.
func (in TechPreview) DeepCopy() TechPreview {
	if in == nil {
		return nil
	}
	out := new(TechPreview)

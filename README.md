...
The Operator uses the [upstream deployment manifests](https://github.com/jetstack/cert-manager/releases/download/v1.13.0/cert-manager.yaml). It divides them into separate files and deploys using 3 controllers:

...
var _ = Describe("ACME Certificate", Ordered, func() {
	...
	Context("dns-01 challenge using explicit credentials", func() {
		It("should obtain a valid LetsEncrypt certificate on AWS cluster", func() {
		...
		It("should obtain a valid LetsEncrypt certificate on GCP cluster", func() {

			// TODO: CM-261. Currently explicitly skip this case for non-GCP plaform.

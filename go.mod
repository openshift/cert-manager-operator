...
require (
	...
	github.com/openshift/build-machinery-go v0.0.0-20240613134546-bcaa8bad8316
...
require (
	...
	k8s.io/kube-aggregator v0.29.13 // indirect
...
replace github.com/cert-manager/cert-manager => github.com/openshift/jetstack-cert-manager v1.14.8-0.20240812090943-99d4b3189900

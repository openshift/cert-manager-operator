...
update_csv_manifest()
{
  ...
  yq e -i '.metadata.annotations."features.operators.openshift.io/cnf"="false"' "${CSV_FILE}"
  yq e -i '.metadata.annotations."features.operators.openshift.io/cni"="false"' "${CSV_FILE}"
  yq e -i '.metadata.annotations."features.operators.openshift.io/csi"="false"' "${CSV_FILE}"

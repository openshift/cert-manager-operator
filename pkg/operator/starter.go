...
// AddonFeatures is the user-specific list of unsupported addon features
// that the operator enables in addition to the default functionality.
var AddonFeatures string
...
func RunOperator(ctx context.Context, cc *controllercmd.ControllerContext) error {
	...
	err = features.SetupWithFlagValue(AddonFeatures)
	if err != nil {

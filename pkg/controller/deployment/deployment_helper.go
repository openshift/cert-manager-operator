...
func mergePodScheduling(sourceScheduling v1alpha1.CertManagerScheduling, overrideSchdeuling v1alpha1.CertManagerScheduling) v1alpha1.CertManagerScheduling {
	// Merge the source and override NodeSelector.
	mergedNodeSelector := labels.Merge(sourceScheduling.NodeSelector, overrideSchdeuling.NodeSelector)
	...
	overridingTolerations := *(*[]core.Toleration)(unsafe.Pointer(&overrideSchdeuling.Tolerations))

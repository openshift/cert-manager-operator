...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !tm.DeletionTimestamp.IsZero() {
		...
		// Per EP, resource cleanup on CR deletion is a non-goal for the initial implementation.
		// Resources will be left in place and an event is emitted to inform the user.
		r.eventRecorder.Eventf(tm, corev1.EventTypeWarning, "RemoveDeployment", "%s trustmanager marked for deletion, remove trust-manager resources manually", tm.GetName())

...
func (r *Reconciler) createOrApplyServiceAccounts(tm *v1alpha1.TrustManager, resourceLabels map[string]string, trustManagerCreateRecon bool) error {
	desired := r.getServiceAccountObject(tm, resourceLabels)
...
func (r *Reconciler) getServiceAccountObject(tm *v1alpha1.TrustManager, resourceLabels map[string]string) *corev1.ServiceAccount {

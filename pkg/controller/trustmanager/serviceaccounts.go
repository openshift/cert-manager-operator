...
func (r *Reconciler) createOrApplyServiceAccounts(trustManager *v1alpha1.TrustManager, resourceLabels map[string]string, trustManagerCreateRecon bool) error {
...
func (r *Reconciler) getServiceAccountObject(resourceLabels map[string]string) *corev1.ServiceAccount {
	...
	updateNamespace(serviceAccount, trustManagerOperandNamespace)

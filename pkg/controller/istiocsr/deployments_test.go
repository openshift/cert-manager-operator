...
// Helper functions for TestCreateOrApplyDeployments to reduce complexity

func setupDeploymentSuccessful(m *fakes.FakeCtrlClient) {
...
func setupDeploymentIssuerNotFound(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentExistsError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
...
func setupDeploymentConfigMapCreateError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentUpdateError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentWithClusterIssuer(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCreateWithStatusError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			return false, nil
...
func setupDeploymentInvalidIssuerRef(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentACMEIssuerError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentIssuerFetchError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentSecretFetchError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentSecretUpdateError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentConfigMapExistsError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentConfigMapUpdateError(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentConfigMapCreateSuccess(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentInvalidConfig(m *fakes.FakeCtrlClient) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMap(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMapCustomNamespace(m *fakes.FakeCtrlClient, configMapName, namespace string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
	...
	m.GetCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) error {
		switch o := obj.(type) {
		case *corev1.ConfigMap:
			if ns.Name == configMapName && ns.Namespace == namespace {
				configMap := testCACertificateConfigMap()
...
func setupDeploymentCACertConfigMapMissing(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
	...
	m.GetCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) error {
		...
		case *corev1.ConfigMap:
			if ns.Name == configMapName {
				return apierrors.NewNotFound(corev1.Resource("configmaps"), configMapName)
			}
		}
		return nil
	})
...
func setupDeploymentCACertConfigMapMissingKey(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMapInvalidPEM(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMapWatchLabelError(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMapNonCA(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func setupDeploymentCACertConfigMapMissingCertSign(m *fakes.FakeCtrlClient, configMapName string) {
	m.ExistsCalls(func(ctx context.Context, ns types.NamespacedName, obj client.Object) (bool, error) {
		switch o := obj.(type) {
		case *appsv1.Deployment:
			deployment := testDeployment()
...
func runDeploymentTest(t *testing.T, r *Reconciler, mock *fakes.FakeCtrlClient, istiocsr *v1alpha1.IstioCSR, skipEnvVar bool, wantErr string) {
	if !skipEnvVar {
	...
	if (wantErr != "" || err != nil) && (err == nil || err.Error() != wantErr) {
		t.Errorf("createOrApplyDeployments() err: %v, wantErr: %v", err, wantErr)
	}
	if wantErr == "" {
...
// Helper functions to reduce cyclomatic complexity in TestCreateOrApplyDeployments

func updateIstioCSRWithClusterIssuer(i *v1alpha1.IstioCSR) {
	i.Spec.IstioCSRConfig.CertManager.IssuerRef.Kind = certmanagerv1.ClusterIssuerKind
}

func updateIstioCSRWithCustomConfig(i *v1alpha1.IstioCSR) {
	updateIstioCSRWithClusterIssuer(i)
...
func updateIstioCSRWithInvalidKind(i *v1alpha1.IstioCSR) {
	i.Spec.IstioCSRConfig.CertManager.IssuerRef.Kind = "invalid"
}

func updateIstioCSRWithInvalidGroup(i *v1alpha1.IstioCSR) {
	i.Spec.IstioCSRConfig.CertManager.IssuerRef.Group = "invalid"
}

func updateIstioCSRWithInvalidToleration(i *v1alpha1.IstioCSR) {
	updateIstioCSRWithClusterIssuer(i)
	i.Spec.IstioCSRConfig.Tolerations = []corev1.Toleration{
		{
...
func updateIstioCSRWithInvalidNodeSelector(i *v1alpha1.IstioCSR) {
	updateIstioCSRWithClusterIssuer(i)
	i.Spec.IstioCSRConfig.NodeSelector = map[string]string{"node/Label/2": "value2"}
}

func updateIstioCSRWithInvalidAffinity(i *v1alpha1.IstioCSR) {
	updateIstioCSRWithClusterIssuer(i)
	i.Spec.IstioCSRConfig.Affinity = &corev1.Affinity{
		NodeAffinity: &corev1.NodeAffinity{
			RequiredDuringSchedulingIgnoredDuringExecution: &corev1.NodeSelector{
...
func updateIstioCSRWithInvalidResources(i *v1alpha1.IstioCSR) {
	updateIstioCSRWithClusterIssuer(i)
	i.Spec.IstioCSRConfig.Resources = corev1.ResourceRequirements{
		Requests: corev1.ResourceList{
			corev1.ResourceCPU:    resource.MustParse("100m"),
...
func updateIstioCSRWithCACertConfigMap(i *v1alpha1.IstioCSR, name string) {
...
func updateIstioCSRWithCACertConfigMapCustomNamespace(i *v1alpha1.IstioCSR, name, namespace string) {
	i.Status.IstioCSRImage = image
	i.Spec.IstioCSRConfig.CertManager.IstioCACertificate = &v1alpha1.ConfigMapReference{
		Name:      name,
		Namespace: namespace,
...
func TestCreateOrApplyDeployments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			runDeploymentTest(t, r, mock, istiocsr, tt.skipEnvVar, tt.wantErr)
		})
	}
}
